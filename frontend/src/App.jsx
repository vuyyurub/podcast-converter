...
function App() {
  ...
  return (
    <div className="relative h-screen w-screen bg-gradient-to-br from-purple-400 via-pink-300 to-yellow-200 flex items-center justify-center">
      <button
        onClick={() => logout({ returnTo: window.location.origin })}
        className="absolute top-5 right-5 bg-red-500 text-white px-4 py-2 rounded shadow-lg z-50"
      >
        Log Out
      </button>
